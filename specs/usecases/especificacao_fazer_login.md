      ...
      <td>
        <ol>
          ...
          <li>
            ...
            redireciona o usuário para a página inicial. <a href="#a1">[A1]</a>, <a href="#a2">[A2]</a>
          </li>
        </ol>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <ol>
          <li>
            O ator executa o fluxo principal, mas digitando credenciais
            incorretas pela segunda vez.
          </li>
          <li>
            O sistema exibe uma mensagem de erro informando que as credenciais
            estão incorretas, informa que seu acesso foi bloqueado <a>[UC2]</a> e solicita
            que o ator entre em contato com o suporte.
          </li>
        </ol>
      </td>
    </tr>
