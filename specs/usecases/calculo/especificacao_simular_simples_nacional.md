<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ol>
          <li>O sistema identifica o Anexo aplicável (I a V) com base no CNAE informado. <a href="#rn1">[RN1]</a></li>
    ...
    <tr>
      ...
      <td>
        ...
        <ol>
          <li>No passo 1, o sistema identifica que o CNAE está sujeito ao Fator R (geralmente Anexo V - serviços).</li>
          <li>O sistema solicita ao ator a Folha de Pagamento dos últimos 12 meses.</li>
          ...
          <li>O sistema continua no passo 4 do fluxo principal.</li>
        </ol>
      </td>
    </tr>
    <tr>
